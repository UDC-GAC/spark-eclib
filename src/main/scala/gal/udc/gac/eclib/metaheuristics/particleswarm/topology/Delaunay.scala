...
/** Delaunay triangulation
  *
  * taken from: https://github.com/mdda/DelaunayScala/blob/master/src/main/scala/Delaunay.scala
  * Other alternative will be: https://github.com/DirkToewe/DelTri4S#delaunay-triangulation
  */
