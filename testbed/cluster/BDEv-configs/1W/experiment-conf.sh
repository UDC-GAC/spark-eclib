...
export BENCHMARK_WAIT_SECONDS=0        # Waiting time (seconds) before each execution of each workload
...
#
##Command
export COMMAND="spark-submit $SPARKOPTS --class $SPARKCLASS $SPARKJAR $PROPFILE"	# Command to run in batch mode
