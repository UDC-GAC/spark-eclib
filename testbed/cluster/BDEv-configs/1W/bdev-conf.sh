...
#export ENABLE_STAT=true		# Enable built-in resource monitoring using dstat/dool
...
export DEFAULT_TIMEOUT=36600	# Default workload timeout
...
#
## Resource stats
#export STAT_GEN_GRAPHS=true	# Generate graphs during execution
#export STAT_SECONDS_INTERVAL=1	# Interval (seconds) for each sample
#
## HPE iLO
