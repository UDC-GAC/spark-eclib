...
../spark/bin/spark-submit \
    ...
    --conf spark.eventLog.dir=/tmp/eclib/history \
    ...
    --conf spark.kubernetes.driver.volumes.hostPath.eclib.mount.readOnly=false \
    ...
    --conf spark.kubernetes.driver.volumes.hostPath.eclib.mount.subpath=history \
